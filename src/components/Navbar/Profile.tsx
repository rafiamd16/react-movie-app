...
const Profile = () => {
  ...
  return (
    <button onClick={handleClick} className='relative flex items-center gap-1 md:gap-2'>
      ...
      <nav
        className={clsx(
          'w-[113px] h-[104px] md:w-[156px] md:h-[128px] rounded-sm bg-[#181A1C] py-1 absolute top-full right-0 scale-0 origin-top-right transition-transform duration-300',
          {
            'scale-100': isOpen,
          },
        )}
      >
        <Link
          to=''
          className='flex items-center py-2 px-3 gap-[5px] text-[10px] font-lato text-[#3254FF] font-medium md:text-sm'
        >
          <svg
            width='12'
            height='12'
        ...
        <Link
          to=''
          className='flex items-center py-2 px-3 gap-[5px] text-[10px] font-lato text-white font-medium md:text-sm'
        >
          <svg
            width='14'
            height='13'
