...
const LoginForm = () => {
  return (
    <form>
      ...
      <InputForm type='password' label='Kata Sandi' id='password' placeholder='Masukkan kata sandi' classname='mb-1' />
      <div className='flex items-center justify-between text-[10px] sm:text-base mb-3 sm:mb-9 '>
