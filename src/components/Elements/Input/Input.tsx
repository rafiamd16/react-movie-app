export const Input = ({
  ...
  return (
    <input
      ...
      className='bg-transparent border border-[#E7E3FC3B] focus:outline-none text-white sm:text-sm text-[9px] py-2 px-3 sm:py-[14px] sm:px-5 rounded-full'
    />
  )
}
  ...
  return (
    <div className='relative w-full mb-1'>
      <input
        ...
        id={id}
        placeholder={placeholder}
        className='w-full bg-transparent border border-[#E7E3FC3B] focus:outline-none text-white sm:text-sm text-[9px] py-2 px-3 sm:py-[14px] sm:px-5 rounded-full'
      />
      <svg
        width='20'
        height='16'
        ...
        className='sm:size-[18px] size-3 absolute sm:right-5 sm:top-4 right-3 top-2.5'
      >
        <path
