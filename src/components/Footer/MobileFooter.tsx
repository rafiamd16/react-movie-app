      ...
      <div className='flex flex-col gap-10'>
        <div className='flex flex-col gap-3'>
          <div className='flex items-center gap-[3px] font-londrina font-normal text-2xl text-white'>
            <svg width='23' height='21' viewBox='0 0 25 21' fill='none' xmlns='http://www.w3.org/2000/svg'>
              <path
        ...
        <div className='flex flex-col w-full gap-2'>
          <div className='flex justify-between text-base font-medium text-white font-lato'>
            <span>Genre</span>
